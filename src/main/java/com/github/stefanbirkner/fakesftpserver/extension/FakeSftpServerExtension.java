...
/**
 * Fake SFTP Server Extension is a JUnit5 extension that runs an in-memory SFTP server
 * while your tests are running.
 * <p>The Fake SFTP Server Extension is used by adding it to your test class.
 * <pre>
 * public class TestClass {
 *   &#064;RegisterExtension
 *   static final FakeSftpServerExtension sftpServer = new FakeSftpServerExtension();
 *
 *   ...
 * }
 * </pre>
 ...
 * avoided by setting the port immediately after creating the server.
 * <pre>
 * public class TestClass {
 *   &#064;RegisterExtention
 ...
 */
public class FakeSftpServerExtension implements BeforeEachCallback, AfterEachCallback {
   ...
   */
  public FakeSftpServerExtension setPort(
      int port
  ) {
   ...
   * @return the rule itself.
   */
  public FakeSftpServerExtension addUser(
      String username,
      String password
  ) {
